...
**Disembodied Head**  
This head can talk, answer questions, and have its own thoughts.  
Magically preserved, it doesn't eat or sleep.

In most cases this lifestyle leads to mild insanity,  
but it all depends on whose head this is.

**Feathered Cloak**  
Wearer takes the form of an eagle.  
Your clothing & gear are with you when you turn back.  
Changing too often is tiring, and may incur [Fatigue](/rules/fatigue/).
...
but on failure it embeds itself somewhere and sends hazardous debris flying.

Roll damage separately for each target.

**Gale Bladder**  
When first opened, this bladder consumes some of the current weather.  
This doesn't end the current weather.

When next opened, this bladder releases the stored weather  
in the general direction you point it, for up to an hour.

**Golden Apple**  
When eaten, you are immediately healthy, warm, well-rested & one year younger.  
These are especially rare.
...
**Oath-Hand**  
This metal hand can crush bones, climb sheer surfaces, & punches for 1d8 damage.
...
| Consumes     | Releases                                                                        |
| ------------ | ------------------------------------------------------------------------------- |
| Blizzard     | Deafening winds & blinding snow                                                 |
